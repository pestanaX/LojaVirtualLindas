...
<?php
     ...
     $descricaoCategoria = $_GET['var']; 
      //print $descricaoCategoria;           	
     //$vectorCategoria = $categoriaDao->listaCompletaCategoria();
     $idCategoria = $categoriaDao->mostrarId($descricaoCategoria);
     $vectorProduto = $produtoDao->pegarProdutoIdCategoria($idCategoria);    
  ...
  <nav class ="nav justify-content-end">
    <ul class ="nav-item">
      ...
      <ul class ="nav-item">
        ...
        <ul class ="nav-item">
          <a  class="nav-link active"  href="Carrinho.php"><img src="img/carrinho.png" class="img-fluid img-thumbnail"  width="40" height="25"></a>                 
        </ul><!-- submenu do submenu do submenu -->
...
<div class ="container">
  ...
  <?php   
        ...
        if (isset($_POST['pesquisa'])) {
          ...
          for ($i = 0 ;$i<=count($vectorProduto)-1;$i++){   
           $visual->imagemPrincipal1($vectorProduto[$i]['id_produto']);  
          }
         } 
